  ...
  return (
    <div className="tnc__container">
      ...
      <p>
        ...
        of NeyX's Website, located at neyx.in.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use neyx if you do not agree to take all
      ...
      <p>
        We employ the use of cookies. By accessing neyx, you agreed to use
        cookies in agreement with the NeyX's Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, NeyX and/or its licensors own the intellectual
        property rights for all material on neyx. All intellectual property
        rights are reserved. You may access this from neyx for your own personal
        use subjected to restrictions set in these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from neyx</li>
        <li>Sell, rent or sub-license material from neyx</li>
        <li>Reproduce, duplicate or copy material from neyx</li>
        <li>Redistribute content from neyx</li>
      </ul>

      <p>This Agreement shall begin on the date hereof 09/10/2021</p>

      <p>
        Parts of this website offer an opportunity for users to post and
        exchange opinions and information in certain areas of the website. NeyX
        ...
        of NeyX,its agents and/or affiliates. Comments reflect the views and
        opinions of the person who post their views and opinions. To the extent
        permitted by applicable laws, NeyX shall not be liable for the Comments
      ...
      <p>
        NeyX reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant NeyX a non-exclusive license to use, reproduce, edit
      ...
      <p>
        ...
        the hyperlink compensates the absence of NeyX; and (d) the link is in
      ...
      <p>
        ...
        e-mail to NeyX. Please include your name, your organization name,
      ...
      <p>
        No use of NeyX's logo or other artwork will be allowed for linking
